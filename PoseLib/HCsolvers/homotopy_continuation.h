...
template<typename Problem, typename Poly, typename Jacobian>
bool compute_dx(double t, Problem &problem, Image &sol, Image &dx) {
...
// template<typename Problem, typename Poly, typename Jacobian>
// HCStats HC_impl(Problem &problem, const HCOptions &opt, Image &sol)
// {
...
//     // TODO: implement this return the image (pose and params)
//     sol = problem.get_sol();
